    ...
    <form action="{{ route('pai.rent.save') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <select class="form-control selectpicker2 @error('client_id') is-invalid @enderror"
                        ...
                        name="client_id" wire:model="client_id" id="client_select"
     ...
     @endphp --}}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <input type="number" class="form-control  @error('rent_amount') is-invalid @enderror"
                        value="{{ old('rent_amount') }}" name="rent_amount" min="0" required />
                    @error('rent_amount')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <input type="date" class="form-control  @error('from_date') is-invalid @enderror"
                        value="{{ old('from_date') }}" name="from_date" required max="9999-12-31" />
                    @error('from_date')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <input type="date" class="form-control  @error('to_date') is-invalid @enderror"
                        value="{{ old('to_date') }}" name="to_date" required max="9999-12-31"/>
                    @error('to_date')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <textarea name="comments" class="form-control" id="" cols="30" rows="10">
                        {{ old('comments') }}
                    </textarea>
                    @error('comments')
                        <div class="invalid-feedback">{{ $message }}</div>
