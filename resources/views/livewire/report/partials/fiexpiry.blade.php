        ...
        @foreach ($deals as $deal)
            <tr>
                ...
                {{-- @if ($this->type == "all") --}}
                 ...
                 <td style="text-align: center">{{  old('fire_insurance_expiry_date', $deal->plot->getMedia('fire_insurance')->isNotEmpty() ? $deal->plot->getMedia('fire_insurance')->first()->getCustomProperty('expiry_date'): '') }}</td>
