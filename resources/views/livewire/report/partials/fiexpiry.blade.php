...
<table   id="customers" >
    <thead>
        <tr>
            ...
            <th style="text-align: center; border:1px solid black" scope="col" class="text-muted">Fire Insurance Expiry</th>
        ...
        @foreach ($deals as $deal)
            <tr>
                ...
                {{-- @if ($this->type == "all") --}}
                 ...
                 <td style="text-align: center; border:1px solid black">{{  old('fire_insurance_expiry_date', $deal->plot->getMedia('fire_insurance')->isNotEmpty() ? $deal->plot->getMedia('fire_insurance')->first()->getCustomProperty('expiry_date'): '') }}</td>
