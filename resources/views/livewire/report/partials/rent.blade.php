...
<table  id="customers">
    ...
    <thead>
        <tr >
            ...
            <th style="text-align: center ; border:1px solid black; " scope="col" class="text-muted">Plot</th>
            ...
            <th style="text-align: center ; border:1px solid black; " scope="col" class="text-muted">Deal Date</th>
            <th style="text-align: center ; border:1px solid black; " scope="col" class="text-muted">Paid Date</th>
            <th style="text-align: center ; border:1px solid black; " scope="col" class="text-muted">Rent Amount</th>
            <th style="text-align: center ; border:1px solid black; " scope="col" class="text-muted">Paid Upto</th>
    ...
    <tbody>
        ...
        @foreach ($deals as $deal)
            <tr>
                ...
                <td style="text-align: center ; border:1px solid black;">{{ $deal->client->id }}</td>
                ...
                <td style="text-align: center ; border:1px solid black;">{{$deal->paiRentPayments->last()->entry_date}}</td>
                <td style="text-align: center ; border:1px solid black;">{{$deal->paiRentPayments->last()->rent_amount}}</td>
                <td style="text-align: center ; border:1px solid black;">{{$deal->paiRentPayments->last()->to_date}}</td>
