    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item {{ (request()->is('tasks*')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                ...
                <li class="menu-item menu-item-submenu {{ (request()->is('report*') ) ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ (request()->is('report/plot*')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                ...
                <li class="menu-item {{ (request()->is('view-detail*')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('view.detail') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-text">View Detail</span>
                    </a>
                </li>
                <li class="menu-item {{ (request()->is('fee-calculation*')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('fee-calculation.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-text">Fee Calculation</span>
                    </a>
                </li>
                ...
                <li class="menu-item menu-item-submenu {{ (request()->is('plots*') || request()->is('deals*') || request()->is('merge*') || request()->is('transfer*') || request()->is('renewals*') || request()->is('split*') ) ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ (request()->is('deals*')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            <li class="menu-item {{ (request()->is('merge*')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{ route('merge.index') }}" class="menu-link">
                                    ...
                                    <span class="menu-text">Merge</span>
                                </a>
                            </li>
                            <li class="menu-item {{ (request()->is('split*')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{ route('split.index') }}" class="menu-link">
                                    ...
                                    <span class="menu-text">Split</span>
                                </a>
                            </li>
                            <li class="menu-item {{ (request()->is('transfers*')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
