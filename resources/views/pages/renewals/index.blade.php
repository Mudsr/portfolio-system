    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Renewals</h3>
            </div>
            <div class="card-toolbar">

                <a href="{{ route('renewals.create') }}" class="btn btn-primary font-weight-bolder">
                ...
                <table class="table table-responsive w-100 d-block d-md-table">
                    ...
                    <tbody>
                        @foreach ($renewals as $renewal)
                            <tr>
                                <td>{{ $renewal->portfolio->name }}</td>
                                <td>{{ $renewal->client->name }}</td>
                                <td>{{ $renewal->plot->area_name }}</td>
                                <td>
                                    <span style="overflow: visible; position: relative">

                                        {{-- <a href="{{ route('portfolio.edit', $renewal->id) }}" class="btn btn-sm btn-clean btn-icon mr-2"
