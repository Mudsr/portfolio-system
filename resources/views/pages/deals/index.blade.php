    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('transfers.create') }}" class="btn btn-primary font-weight-bolder mr-2">
                ...
                <a href="{{ route('deals.create') }}" class="btn btn-primary font-weight-bolder mr-2">
                    <span class="svg-icon svg-icon-md">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                            height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span style="overflow: visible; position: relative">
                                        ...
                                        {{-- <a href="{{ route('portfolio.edit', $deal->id) }}" class="btn btn-sm btn-clean btn-icon mr-2"
